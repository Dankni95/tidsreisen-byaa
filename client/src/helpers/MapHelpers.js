        ...
        features: [
            {
                ...
                properties: {
                    ...
                    title: "Vesledammen",
                    description: "Langs sidene på Byåa er det murt opp stein på begge sider, på sørsiden er den 1,4 meter lang, mer utydelig på nordsiden, men det ligger en stor steinblokk på 50 x 50 cm på kanten. Det er også stein på kantene som ser ut som fundament til en liten bygning, mest på sørsiden.",
            ...
            },
            {
                ...
                properties: {
                    ...
                    description: "Lokaliteten ligger ved Byåa, vest for Nedre Rælingsvei. Sporene etter vannsagen eller eventuelt et kvernhus som har stått i nærheten er i dag borte, sannsynlig på grunn av anleggelse av veier som Ulleråsen og Nedre Rælingsvei.",
                    url: "/quiz?murogstokker"
                },
            },
            {
                type: "Feature",
                ...
                properties: {
                    ...
                    title: "Veganlegg",
                    description: "En tydelig hulveg som ligger i en skråning ned mot Byåa, retning på hulveien er NV-SØ. Målene på hulvegen er 1,30 meter i bunn og 4 meter bred i toppen. Dybden på vegen er 1,15 meter. Ligger i åpent gressbevokst terreng med utsikt mot Øyeren i øst.",
                    url: "/audio?Veganlegg"
                },
            },
            {
                ...
                properties: {
                    ...
                    anim_zoom: 18.746185138382017,
                    title: "Sagbruk",
                    description: "2 murer etter vannsag. I hovedsak er de bygget av stor bruddstein. Murene er uten bevoksning. L 15m, h 2-3m, tykkelse 1,25m. Ca 100m S for kryss Byåa og hovedveien: Rester av mølle? Sees i form av trekonstruksjoner, hvorav det meste er rasert. Ca 10 m S for og ovenfor trekonstruksjonen og på V-bredden: Tørrmur, l 20m. 5m ovenfor dennes slutt finnes en sementert demning, parallelt og på hver side av bekken, orientert N-S. ",
                    url: "/history?sagbruk"
                },
            },
            {
                ...
                properties: {
                    ...
                    description: "Sør for gårdstunet på By og på nordre siden av Byåa ligger et fundament etter en sag. Sagen ligger rett nedenfor en bratt skråning på en liten flate ved elva. Det er ingen høye murer igjen da steinene er igjenbrukt andre steder.",
                    url: "/quiz?sagtuft"
